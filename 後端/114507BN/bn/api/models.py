...
class ActivationCode(models.Model):
    """【最新版】用於管理系統級別的、可多次使用的註冊啟用碼。"""
    code = models.CharField(max_length=16, unique=True, verbose_name="啟用碼")
    max_uses = models.PositiveIntegerField(default=50, verbose_name="最大使用次數")
    current_uses = models.PositiveIntegerField(default=0, verbose_name="當前使用次數")    
