// 檔案路徑: static/js/pages/all_reports.js (新檔案)
...
(function() {
    ...
    async function initializePage() {
        ...
        // 更新側邊欄
        document.getElementById('sidebar-username').textContent = userProfile.first_name || userProfile.username;

        try {
            // 根據使用者權限決定要獲取誰的行程
            // 如果是管理員，可以查看所有人的。這裡我們先簡化為只看自己的
            ...
            document.getElementById('reports-grid-container').innerHTML = '<p style="color: red;">載入資料失敗，請稍後再試。</p>';
        }
    }
